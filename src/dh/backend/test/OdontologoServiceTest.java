...
class OdontologoServiceTest {
    ...
    static void crearTablas(){
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:h2:~/db_backendTest_Roberto-Giler__Martin-Aguilar;INIT=RUNSCRIPT FROM 'create.sql'", "sa", "sa");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @Test
    @DisplayName("Testear que Listar a todos los odontologos")
